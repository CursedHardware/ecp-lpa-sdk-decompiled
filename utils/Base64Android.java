...
public class Base64Android {
    ...
    static class Decoder extends Coder {
        ...
        public boolean process(byte[] r17, int r18, int r19, boolean r20) {
            ...
            L_0x0122:
                ...
                goto L_0x00bf
            */
            throw new UnsupportedOperationException("Method not decompiled: com.eastcompeace.lpa.sdk.utils.Base64Android.Decoder.process(byte[], int, int, boolean):boolean");
        }
    }
    ...
    static class Encoder extends Coder {
        ...
        static {
            Class<Base64Android> cls = Base64Android.class;
        }
        ...
        public boolean process(byte[] r18, int r19, int r20, boolean r21) {
            ...
            L_0x01d8:
                ...
                return r9
            */
            throw new UnsupportedOperationException("Method not decompiled: com.eastcompeace.lpa.sdk.utils.Base64Android.Encoder.process(byte[], int, int, boolean):boolean");
        }
    }
}
