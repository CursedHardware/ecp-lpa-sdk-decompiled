...
public class HttpManagerS {
    ...
    private void init() {
        ...
        OkHttpClient.Builder hostnameVerifier = new OkHttpClient.Builder().connectTimeout(5, TimeUnit.SECONDS).readTimeout(5, TimeUnit.SECONDS).writeTimeout(5, TimeUnit.SECONDS).retryOnConnectionFailure(false).sslSocketFactory(MySSLSocketClient.getSSLSocketFactory(), MySSLSocketClient.X509).hostnameVerifier(MySSLSocketClient.getHostnameVerifier());
    ...
    public static final class Builder {
        ...
        public Builder get() {
            this.requestType = HttpManagerS.GET;
            this.requestBodyType = 0;
            return this;
        }

        public Builder postForm() {
            this.requestType = HttpManagerS.POST;
        ...
        public HttpManagerS build() {
            HttpManagerS instance = HttpManagerS.getInstance();
            ...
            Request unused2 = HttpManagerS.request = new Request.Builder().url(this.url).headers(this.headerBuilder.build()).method(this.requestType, requestBody).build();
            return instance;
        }
        ...
        private RequestBody getRequestBody() {
            ...
            if (this.requestBodyType == 2) {
                try {
                    ...
                    ELog.e(HttpManagerS.TAG, "getRequestBody: ", e);
                    return null;
                }
            } else {
