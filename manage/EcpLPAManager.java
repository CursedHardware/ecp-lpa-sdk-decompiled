...
public class EcpLPAManager {
    public static final String AID = "A0000005591010FFFFFFFF8900000100";
    private static final String TAG = "EcpLPAManager";
    private static volatile EcpLPAManager instance;
    /* access modifiers changed from: private */
    public EuiccController euiccController;
    /* access modifiers changed from: private */
    public Handler handler = new Handler();

    private EcpLPAManager() {
    }

    public static EcpLPAManager getInstance() {
        EcpLPAManager ecpLPAManager;
        synchronized (EcpLPAManager.class) {
            if (instance == null) {
                instance = new EcpLPAManager();
            }
            ecpLPAManager = instance;
        }
        return ecpLPAManager;
    }

    public EcpLPAManager init(IChannel iChannel, String str) {
    ...
    public EcpLPAManager setLog(Ilog ilog) {
        ELog.setLog(ilog);
        return this;
    }
    ...
    public void getProfilesInfos(final IEs10xFunction.CallBack<List<ProfileInfo>> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.getProfilesInfos(new IEs10xFunction.CallBack<List<ProfileInfo>>() {
                        public void onComplete(final int i, final List<ProfileInfo> list, final String str) {
                            EcpLPAManager.this.handler.post(new Runnable() {
                                public void run() {
    ...
    public void enableProfile(final String str, final boolean z, final IEs10xFunction.CallBack<Void> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.enableProfile(str, z, new IEs10xFunction.CallBack<Void>() {
    ...
    public void disableProfile(final String str, final boolean z, final IEs10xFunction.CallBack<Void> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.disableProfile(str, z, new IEs10xFunction.CallBack<Void>() {
                        public void onComplete(final int i, final Void voidR, final String str) {
                            EcpLPAManager.this.handler.post(new Runnable() {
                                public void run() {
                                    callBack.onComplete(i, voidR, str);
    ...
    public void deleteProfile(final String str, final IEs10xFunction.CallBack<Void> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.deleteProfile(str, new IEs10xFunction.CallBack<Void>() {
                        public void onComplete(final int i, final Void voidR, final String str) {
                            EcpLPAManager.this.handler.post(new Runnable() {
                                public void run() {
                                    callBack.onComplete(i, voidR, str);
    ...
    public void setNickName(final String str, final String str2, final IEs10xFunction.CallBack<Void> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.setNickName(str, str2, new IEs10xFunction.CallBack<Void>() {
                        public void onComplete(final int i, final Void voidR, final String str) {
                            EcpLPAManager.this.handler.post(new Runnable() {
                                public void run() {
                                    callBack.onComplete(i, voidR, str);
    ...
    public void downLoadStepOne(final ActivationCode activationCode, final IEs10xFunction.CallBack<AuthenticateClientBean> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.auth(activationCode, new IEs10xFunction.CallBack<AuthenticateClientBean>() {
    ...
    public void downLoadStepOne(final String str, final String str2, final IEs10xFunction.CallBack<AuthenticateClientBean> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.auth(str, str2, new IEs10xFunction.CallBack<AuthenticateClientBean>() {
                        public void onComplete(final int i, final AuthenticateClientBean authenticateClientBean, final String str) {
                            EcpLPAManager.this.handler.post(new Runnable() {
                                public void run() {
                                    callBack.onComplete(i, authenticateClientBean, str);
    ...
    public void downLoadStepTwo(final AuthenticateClientBean authenticateClientBean, final String str, final IEs10xFunction.CallBack<String> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.downLoadProfile(authenticateClientBean, str, new IEs10xFunction.CallBack<String>() {
    ...
    public void notificationOpera(final int i, final String str, final IEs10xFunction.CallBack<Void> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.notificationOpera(i, str, callBack);
                }
            });
        }
    }
    ...
    public void removeNotificationFromList(final String str, final IEs10xFunction.CallBack<Void> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.removeNotificationFromList(str, new IEs10xFunction.CallBack<Void>() {
                        public void onComplete(final int i, final Void voidR, final String str) {
                            EcpLPAManager.this.handler.post(new Runnable() {
                                public void run() {
                                    callBack.onComplete(i, voidR, str);
    ...
    public void listNotification(final int i, final IEs10xFunction.CallBack<List<Notification>> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.listNotification(i, new IEs10xFunction.CallBack<List<Notification>>() {
    ...
    public void getDefaultSmdpAddress(final IEs10xFunction.CallBack<String> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.getDefaultSmdpAddress(new IEs10xFunction.CallBack<String>() {
                        public void onComplete(final int i, final String str, final String str2) {
                            EcpLPAManager.this.handler.post(new Runnable() {
                                public void run() {
                                    callBack.onComplete(i, str, str2);
    ...
    public void getSmdsAddress(final IEs10xFunction.CallBack<String> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.getSmdsAddress(new IEs10xFunction.CallBack<String>() {
                        public void onComplete(final int i, final String str, final String str2) {
                            EcpLPAManager.this.handler.post(new Runnable() {
                                public void run() {
                                    callBack.onComplete(i, str, str2);
    ...
    public void getSmdpFromSmds(final String str, final IEs10xFunction.CallBack<Es11AuthenticateClientBean> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.getSmdpFromSmdsAddress(str, new IEs10xFunction.CallBack<Es11AuthenticateClientBean>() {
    ...
    public void cancelSession(final String str, int i) {
        if (checkEuiccController((IEs10xFunction.CallBack) null)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.cancelSession(str, 0);
                }
            });
        }
    }
    ...
    public void setDefaultDpAddress(final String str, final IEs10xFunction.CallBack<Void> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.setDefaultDpAddress(str, new IEs10xFunction.CallBack<Void>() {
                        public void onComplete(final int i, final Void voidR, final String str) {
                            EcpLPAManager.this.handler.post(new Runnable() {
                                public void run() {
                                    callBack.onComplete(i, voidR, str);
    ...
    public void resetMemory(final int i, final IEs10xFunction.CallBack<Void> callBack) {
        if (checkEuiccController(callBack)) {
            ThreadManager.initExceutor().execute(new Runnable() {
                public void run() {
                    EcpLPAManager.this.euiccController.resetMemory(i, new IEs10xFunction.CallBack<Void>() {
                        public void onComplete(final int i, final Void voidR, final String str) {
                            EcpLPAManager.this.handler.post(new Runnable() {
                                public void run() {
                                    callBack.onComplete(i, voidR, str);
